          ...
          <div id="myCarousel" class="carousel slide" data-ride="carousel">
              ...
              <div class="carousel-inner">
                  <div class="item active">
                      <img src="./assets/media/img/3/images/Soul-Quartet-Marc-1.jpeg" alt="First Slide">
                  </div>
                  <div class="item">
                      <img src="./assets/media/img/3/images/Soul-Quartet-Nicole-1.jpeg" alt="Second Slide">
                  </div>
                  <div class="item">
                      <img src="./assets/media/img/3/images/Soul-Quartet-6.jpeg" alt="Third Slide">
                  </div>
              </div>
              <!-- Carousel controls -->
